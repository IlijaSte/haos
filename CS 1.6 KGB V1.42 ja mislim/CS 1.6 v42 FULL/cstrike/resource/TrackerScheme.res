...
Scheme
{
	...
	Colors
	{
		...
		"BrightBaseText"		"255 0 0 255"	// brightest text
		"SelectedText"		"255 0 0 255"	// selected text
		"DimBaseText"		"150 150 150 255"	// dim base text
		"LabelDimText"		"100 100 100 255"	// used for info text
		"ControlText"		"200 200 200 255"	// used in all text controls
		"BrightControlText"	"255 255 255 255"	// use for selected controls
		"DisabledText1"		"80 80 80 255"	// disabled text
		"DisabledText2"		"80 80 80 255"	// overlay color for disabled text (to give that inset look)
		"DimListText"		"80 80 80 255"	// offline friends, unsubscribed games, etc.
		...
		// border colors
		"BorderBright"		"80 80 80 255"	// the lit side of a control
